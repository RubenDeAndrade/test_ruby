class AssociationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @association.save
        format.html { redirect_to @association, success: 'Association was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @association.update(association_params)
        format.html { redirect_to association_path(@association.id), success: 'Association was successfully updated.' }
